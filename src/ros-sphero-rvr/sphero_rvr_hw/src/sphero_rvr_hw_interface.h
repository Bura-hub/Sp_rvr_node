#ifndef ROS_CONTROL_SPHERO_RVR_HW_INTERFACE_H
#define ROS_CONTROL_SPHERO_RVR_HW_INTERFACE_H
...
{
  class SpheroRVRHWInterface : public hardware_interface::RobotHW
  {
    public:
      /**
       * \brief Constructor
       ...
       */
      SpheroRVRHWInterface(ros::NodeHandle &nh, urdf::Model *urdf_model = NULL);

      /** \brief Destructor */
      virtual ~SpheroRVRHWInterface() {}
    ...
    protected:
      ...
      SpheroRVRHWInterface *sphero_rvr;
      ...
      //SerialPort serial_port_ { "/dev/ttyS0", 115200 };
      //rvr::SendPacket< rvr_out_ { serial_port_ };
      //rvr::ReadPacket rvr_in_ { serial_port_ };
      //rvr::Blackboard bb_;
	    //rvr::Power power_(rvr::Blackboard bb_, rvr::SendPacket rvr_out_);
	    //rvr::Drive drive_(rvr::Blackboard bb_, rvr::SendPacket rvr_out_);
	    //rvr::SensorsDirect sensors_d_(rvr::Blackboard bb_, rvr::SendPacket rvr_out_);
	    //rvr::SensorsStream sensors_s_(rvr::Blackboard bb_, rvr::SendPacket rvr_out_);
      //rvr::VelocityData v_;
